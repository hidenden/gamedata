...
@app.cell
def _(ui_annotation, ui_begin_date, ui_end_date, ui_hws, ui_mode, ui_multiline):
...
@app.cell
def _(ui_annotation, ui_delta_begin, ui_delta_end, ui_hws, ui_mode, ui_multiline):
...
@app.cell
def _(ui_multiline, ui_period_end, ui_periods):
...
@app.cell
def _(ui_annotation, ui_multiline):
...
@app.cell
def _(ui_annotation, ui_hws, ui_multiline, ui_year):
